...
const { getPublicClientConfig, cssVariables } = require('./lib/clientConfig');
...
app.get('/api/client-config', (req, res) => {
    res.status(200).json(getPublicClientConfig());
});

app.get('/api/client-theme.css', (req, res) => {
    res.type('text/css').send(cssVariables());
});
